/* Auto-generated by genmsg_cpp for file /tmp/buildd/ros-groovy-pr2-object-manipulation-0.7.5/debian/ros-groovy-pr2-object-manipulation/opt/ros/groovy/stacks/pr2_object_manipulation/manipulation/pr2_gripper_sensor_msgs/msg/PR2GripperFindContactAction.msg */
...
struct PR2GripperFindContactAction_ {
  ...
  typedef  ::pr2_gripper_sensor_msgs::PR2GripperFindContactActionGoal_<ContainerAllocator>  _action_goal_type;
   ::pr2_gripper_sensor_msgs::PR2GripperFindContactActionGoal_<ContainerAllocator>  action_goal;

  typedef  ::pr2_gripper_sensor_msgs::PR2GripperFindContactActionResult_<ContainerAllocator>  _action_result_type;
   ::pr2_gripper_sensor_msgs::PR2GripperFindContactActionResult_<ContainerAllocator>  action_result;

  typedef  ::pr2_gripper_sensor_msgs::PR2GripperFindContactActionFeedback_<ContainerAllocator>  _action_feedback_type;
   ::pr2_gripper_sensor_msgs::PR2GripperFindContactActionFeedback_<ContainerAllocator>  action_feedback;
...
{
template<class ContainerAllocator> struct IsMessage< ::pr2_gripper_sensor_msgs::PR2GripperFindContactAction_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::pr2_gripper_sensor_msgs::PR2GripperFindContactAction_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
