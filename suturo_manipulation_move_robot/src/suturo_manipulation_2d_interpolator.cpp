...
// Suturo_Manipulation_2d_Interpolator::Suturo_Manipulation_2d_Interpolator()
// {
...
const interpolator_2d_result &Suturo_Manipulation_2d_Interpolator::interpolate(const interpolator_2d_params &params)
{
    ...
    // ROS_INFO_STREAM("trajectory_input set");
    ...
    // ROS_INFO_STREAM("x: " << q_.data(0) << " y: " << q_.data(1));
